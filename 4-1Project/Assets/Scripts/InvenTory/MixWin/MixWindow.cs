...
public class MixWindow : MonoBehaviour
{
    ...
    public void ClickArmorTab(int _tabNum) // 방어구 탭 클릭 시
    {
        UpdateRecipeSlot(armorRecipe);
        ChangeTabColor(_tabNum);
    }

    public void ClickWeaponTab(int _tabNum) // 무기 탭 클릭 시
    {
        UpdateRecipeSlot(weaponRecipe);
        ChangeTabColor(_tabNum);
    }

    public void ClickSubWeaponTab(int _tabNum) // 보조무기 탭 클릭 시
    {
        UpdateRecipeSlot(subweaponRecipe);
        ChangeTabColor(_tabNum);
    }

    public void ClickAccessoryTab(int _tabNum) // 액세서리 탭 클릭 시
    {
        UpdateRecipeSlot(accessoryRecipe);
        ChangeTabColor(_tabNum);
    }

    public void ClickActiveTab(int _tabNum) // 액티브 탭 클릭 시
    {
