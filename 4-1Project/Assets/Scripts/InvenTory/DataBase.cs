...
public class DataBase : MonoBehaviour
{
    ...
    {
        // Material Item
        itemList.Add(new Item(1, "헤르나이트", "가이테리움과 에레로늄의 융화로 만들어진 헤븐헤르벨을 구성하는 핵의 일부.", "hernite"));
        itemList.Add(new Item(2, "아스바타의 파편", "아스바타의 기지에서 떨어져나온 파편. 아스바타의 기운을 담고 있다.", "ashvattha"));
        itemList.Add(new Item(3, "나뭇가지", "평범한 나뭇가지.", "twig"));
        itemList.Add(new Item(4, "천 조각", "지저분한 직물조각.", "fabric"));
        itemList.Add(new Item(5, "낡은 철조각", "부서진 철 조각.", "iron"));
        itemList.Add(new Item(6, "연마제", "녹을 지워내는 연마제", "powder"));
        itemList.Add(new Item(7, "가이테리움", "가이테르벨을 구성하던 핵의 일부.", "gaiter"));
        itemList.Add(new Item(8, "에레로늄", "에레로스벨을 구성하던 핵의 일부.", "Ereronium"));
        itemList.Add(new Item(9, "빛바랜 훈장", "가이테르벨을 지키던 기사들에게 수여된 훈장.", "pendant"));
        itemList.Add(new Item(10, "연금서", "에레로스 마법의 비전이 담긴 연금서.", "alchemy"));
        ...
        // Equipment Item
        itemList.Add(new Item(207, "보스방 열쇠", "이 열쇠가 있어야 보스방에 입장할 수 있습니다.", "bosskey"));
        itemList.Add(new Item(201, "선지자의 로브", "방어력 +15\n스킬쿨타임 5%감소", "robe"));
        itemList.Add(new Item(202, "선지자의 탈리스만", "스킬쿨타임 20% 감소", "talisman"));
        itemList.Add(new Item(203, "선지자의 스태프", "공격력 +35\n공격속도 +15", "staff"));
        itemList.Add(new Item(204, "선구자의 갑옷", "방어력 +30", "armor"));
        itemList.Add(new Item(205, "선구자의 건틀릿", "공격속도 +20", "gauntlet"));
        itemList.Add(new Item(206, "선구자의 망치", "공격력 +35\n공격속도 +15", "hammer"));
